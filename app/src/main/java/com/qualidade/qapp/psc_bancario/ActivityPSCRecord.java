...
public class ActivityPSCRecord extends AppCompatActivity {
    ...
    private com.qualidade.qapp.psc_bancario.MAdapter adapter;
    ...
    public void buildRecyclerView() {
        ...
        adapter = new MAdapter(itemCards);

        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(adapter);

        adapter.setOnItemClickListener(new com.qualidade.qapp.psc_bancario.MAdapter.OnItemClickListener() {
            @Override
