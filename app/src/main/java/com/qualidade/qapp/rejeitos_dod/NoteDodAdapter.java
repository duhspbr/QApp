...
import com.qualidade.qapp.psc_bancario.MAdapter;
...
public class NoteDodAdapter extends RecyclerView.Adapter<NoteDodAdapter.MViewHolder> {
    private List<NoteDOD> noteDODS = new ArrayList<>();
    ...
    public int getItemCount() {
        return noteDODS.size();
    }

    public void setNoteDODS(List<NoteDOD> noteDODS) {
        this.noteDODS = noteDODS;
